...
# Sample responses for greetings
...
KNOWLEDGE_BASE = {
    ...
    "who is the owner of facebook": "The owner of Facebook, now called Meta Platforms, Inc., is Mark Zuckerberg, who co-founded it."
}
...
def get_response(user_response):
    user_response = user_response.lower()  # Convert user input to lowercase
